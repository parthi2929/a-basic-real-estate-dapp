...
(function () {
    ...
    var TradingView = {
        host: window.location.host.match(/tradingview\.com|pyrrosinvestment\.com/i) == null ? "" : "https://www.tradingview.com",
        //host: location.host,
    ...
    TradingView.widget.prototype = {
        ...
        generateUrl: function (options) {
            ...
            var host = "http://" + location.host; // options.enable_publishing ? TradingView.ideasHost : TradingView.host;
