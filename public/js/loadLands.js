...
function updateListDisplay(land)
{
    ...
    var myCard = $('<div class="card" id="inlineCard' + i + '" style="width:250px"><img src="https://s14.postimg.org/b7n0s9csh/land.jpg"><h5>landID: '+ i +'</h5><span>Location: '+ location +'</span><span>Cost: '+ cost +'</span></div>');
